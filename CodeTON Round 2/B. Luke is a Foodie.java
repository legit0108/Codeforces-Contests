...
public class Main {
  ...
  // simulate the situation using ranges of v
  // for each range we try to set value of v 
  // according to the innermost range
  // if and only if the current range
  // coincides with the previous ranges
  ...
  static void solve() throws Exception{
    ...
    while(idx<n){
      long currStart = arr[idx]-x;
      long currEnd = arr[idx]+x;
      ...
      if(start==-1&&end==-1){
          ...
          if(currStart>end||currEnd<start){
              ...
              start = Math.max(currStart,start);
