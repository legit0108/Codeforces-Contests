...
public class Main {
  ...
  // idea : copy pasted , asked to query k'th letter
  // it will be present in original string
  // each query can be answered in O(c)
  // we backtrack each operation
  // if substring l to r is copied , and we are asked to query k'th letter
  // then that letter will be present at a distance of k-n' from l in original string
  // where n' is length of string before copy
  
  // k = k-n'
  // k = l+k-1
  // pos = c
  // while pos > 0 continue backtracking
  // length of string after last operation >=k pos--
  // store length of string at each step
  ...
  static void solve() throws Exception{
    ...
    for(int idx=1;idx<=c;idx++){
        ...
        len[idx] = len[idx-1]+r[idx]-l[idx]+1;
    }
    ...
    while(q-->0){
        ...
        // after this while loop we now know the position of character
        // in original string
        
        sb.append(str.charAt((int)k)).append("\n");
    }
  }
