...
public class Main {
  ...
  /*
   ...
   Let the number of ones in string be 'ones'
   for a team X to win, there should be 2^ones - 1 teams having less skill than X
   let the number of zeros be 'zeros', for a team X to win, there should be 2^zeros - 1 teams having more skill than X 
   teams satisfying above stated bound will definitely win in some permutation 'p'
  ...
  */
  ...
  static void solve() throws Exception{
    ...
    for(int idx=0; idx<n; idx++){
        if(s.charAt(idx)=='0') zeros++;
        else ones++;
    }
    
    for(long num = 1l<<ones; num<=((1l<<n) - ((1l<<zeros) - 1)); num++) sb.append(num).append(" ");
