...
public class Main {
 ...
 /*
   ...
   The line we draw must go through a triangle's vertex, otherwise, two sides of the triangle are split, and one of the resulting parts becomes a rectangle.
 ...
 */
  ...
  static void solve() {
    ...
    if(distinct(x1, x2, x3) || distinct(y1, y2, y3)) sb.append("YES\n");
    else sb.append("NO\n");
  }
  
  private static boolean distinct(long num1, long num2, long num3){
