...
public class Main {
  ...
  // array should be monotonically increasing / decreasing / mountain in nature
  // for it to be a minimal permutation
  ...
  static void solve() throws Exception{
    ...
    int idx = 0;
    while(idx<n-1&&arr[idx+1]>=arr[idx]) idx++;
    while(idx<n-1&&arr[idx]>=arr[idx+1]) idx++;
    
    if(idx==n-1) sb.append("YES\n");
    else sb.append("NO\n");
  }
