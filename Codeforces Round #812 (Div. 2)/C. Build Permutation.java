...
public class Main {
  ...
  // start building permutation from the right
  ...
  static void solve() throws Exception{
    ...
    while(idx>=0){
        for(int compl = 0;compl<=idx;compl++){
            int possibleSquare = compl+idx;
            int sqrt = (int)Math.sqrt(possibleSquare);

            if(sqrt*sqrt==possibleSquare){
                int start = compl;
                int end = idx;
