...
public class Main {
  ...
  /*
   Count of inversions for an element remain same regardless of permutation   
   ...
   Inversions for a permutation  = n*(n-1)
   Total inversions = n!*n*(n-1)
