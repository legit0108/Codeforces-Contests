...
public class Main {
  ...
  // Either 3 odd numbers sum up to an odd number or 2 even + 1 odd number sum up to an odd number
  ...
  static void solve() {
    ...
    for(int idx=0; idx<n; idx++){
        ...
        if(val%2==0){
            if(even1==-1) even1 = pos;
            else even2 = pos;
        }else{
            if(odd1==-1) odd1 = pos;
            else if(odd2==-1) odd2 = pos;
            else odd3 = pos;
        }
    }
    ...
    if(odd1!=-1 && odd2!=-1 && odd3!=-1){
        sb.append("YES\n");
        sb.append(odd1).append(" ").append(odd2).append(" ").append(odd3).append("\n");
    }else if (even1!=-1 && even2!=-1 && odd1!=-1){
        sb.append("YES\n");
        sb.append(even1).append(" ").append(even2).append(" ").append(odd1).append("\n");
    }else sb.append("NO\n");
  } 
