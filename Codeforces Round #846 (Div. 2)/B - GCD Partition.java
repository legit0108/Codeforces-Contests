...
public class Main {
  ...
  /*
    Reduce the number of subsegments to 2, that is the best case for us to consider
    
    TC: O(nlog(min(sum, preSum))
    SC: O(1) if iterative gcd implemented
  */
