...
public class Main {
  ...
  /*
   Sum of [1....2n] = 2n/2(1+2n) = n(1+2n) -> 1
   Sum of all pairs (x1+y1, x2+y2, x3+y3, .... xn+yn) = n/2(2a+(n-1)d) = n/2(2a+(n-1)) = n/2(2a+n-1) -> 2
   We know 1 == 2
   Equating 1 and 2, we get: 
   a = x1+y1 = (3+3n)/2, (3+3n)%2 == 0 for answer to exist since x1+y1 is an integer
   Odd + Odd = Even, 3 is odd, 3n needs to be odd for 3+3n to be even
   3n is odd if n is odd, so if n is even answer does not exist
   We can always find an arrangement if n is odd
