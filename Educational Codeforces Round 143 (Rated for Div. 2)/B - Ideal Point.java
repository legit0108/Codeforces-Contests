...
public class Main {
  ...
  /*
    First of all, let's delete all segments that do not cover the point k
    (because they increase the value of the function f at points other than k). 
    If there are no segments left, then the answer is NO. Otherwise, all segments cover the point k. 
    And it remains to check whether the point k is the only point which is covered by all segments. 
