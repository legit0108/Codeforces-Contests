...
public class Main {
  ...
  // simulate the situation given
  // keep opening the door with same number
  // as current key and keep collecting 
  // the key behind every door
  ...
  static void solve() throws Exception{
    int key = i();
    int keys[] = new int[4];
    for(int door = 1;door<=3;door++) keys[door] = i();
    int doors = 1;
