...
public class Main {
  ...
  static void solve() throws Exception{
    ...
    if(neg>=3||pos>=3) sb.append("NO\n");
    else{
        if((neg==2&&zero==1)||(pos==2&&zero==1)) sb.append("NO\n");
        else if((neg==1&&pos==0)||(pos==1&&neg==0)||(pos==0&&neg==0)) sb.append("YES\n");
        else if((neg==1&&pos==1)){
                    ...
                    for(int idx2=idx1+1;idx2<n;idx2++){
                        for(int idx3=idx2+1;idx3<n;idx3++){
                            ...
                            for(int idx4=0;idx4<n;idx4++){
                                if(arr[idx1]+arr[idx2]+arr[idx3]==arr[idx4]){
                                    found = true;
                                    break;
                                }
                            }
