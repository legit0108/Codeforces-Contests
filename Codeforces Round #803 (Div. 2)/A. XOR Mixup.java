...
public class Main {
  ...
  // TC : O(1)
  // SC : O(1)
  // assuming we are given array

  // the xor of given array (total xor) will be 0
  // if current element at idx is x
  // condition : (total xor ^ arr[idx]) = arr[idx] should satisfy
  // this satisfies for every idx because total xor is 0
  // so we can print any element
