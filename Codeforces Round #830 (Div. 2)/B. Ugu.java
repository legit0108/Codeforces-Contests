...
public class Main {
  ...
  /*
   ...
   Valid format of answer : 000____000, 111____111, 000____111
   Do not apply operations on existing non decreasing part(minimize cost)
   Flip at some index if and only if it is required
  ...
  */
  ...
  static void solve() {
    ...
    for(int idx=1; idx<n; idx++){
        ...
        char prevCh = str.charAt(idx-1);
        
        if(currCh!=prevCh){
            if(!flipped && currCh=='0'){
                minOps++;
                flipped = true;
            }else if(flipped) minOps++; // regardless of whether currCh=='0' || currCh=='1'
        }
    }
