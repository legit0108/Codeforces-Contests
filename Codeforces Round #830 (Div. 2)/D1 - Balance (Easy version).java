...
public class Main {
  ...
  If a request comes to us for the first time for a given k, then we calculate the answer for it greedily and remember it. In the future, 
  we will no longer check with 0 whether there is a number in the set, but with the previous answer
  ...
  */
  ...
  static void solve() throws Exception{
    ...
    if(op.equals("+")){
        ...
        long prev = map.getOrDefault(num, 0l);
